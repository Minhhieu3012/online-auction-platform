...
-- 6. Bảng Fraud_Alerts (Lịch sử phát hiện gian lận của AI)
-- Thành (AI Service) sẽ lưu kết quả chấm điểm vào đây để Frontend query
CREATE TABLE Fraud_Alerts (
    id          INT AUTO_INCREMENT PRIMARY KEY,
    auction_id  INT NOT NULL,
    user_id     INT NOT NULL,
    risk_score  DECIMAL(3,2) NOT NULL, -- Giá trị từ 0.00 đến 1.00
