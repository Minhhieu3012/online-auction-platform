...
const listMyBids = safeController(AuctionController, "listMyBids", "Lượt giá của tôi");
 ...
 * QUAN TRỌNG: Các route tĩnh (/mine, /won, /my-bids) phải đứng TRƯỚC
 * route động (/:id) để Express không hiểu nhầm chúng là auction ID.
 */
...
router.get("/my-bids", authMiddleware, listMyBids);
